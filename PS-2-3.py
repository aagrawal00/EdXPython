...
paymentupperbound=(balance*(pow((1+monthlyInterestRate),12)))/12.0
while balance!=0:
    balance=originalbalance
    minmonthlypayment=(paymentlowerbound+paymentupperbound)/2
    for i in range(1,13):
    ...
    if   balance>0:
        paymentlowerbound=minmonthlypayment
    elif balance<0:
        paymentupperbound=minmonthlypayment
